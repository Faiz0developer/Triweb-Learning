...
// Converting binary value 101 to decimal    It handle 101 as binary
console.log(parseInt(n8, 2)); //5

// Converting hexadecimal value 101 to decimal    It handle 101 as hexadecimal
console.log(parseInt(n8, 16)); //257

// Converting octal value 101 to decimal    It handle 101 as octal
console.log(parseInt(n8, 8)); //65
